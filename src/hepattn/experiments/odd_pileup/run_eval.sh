...
export M_ODD=/storage/agrp/barakma/hepattn/src/hepattn/experiments/odd/logs/odd_pflow_v1_clic_arch_20260128-T131927
export CKPT_PATH=${M_ODD}/ckpts/epoch=119-val_loss=4.43505.ckpt
