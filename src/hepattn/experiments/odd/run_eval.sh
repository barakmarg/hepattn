...
export M_ODD=/storage/agrp/barakma/hepattn/src/hepattn/experiments/odd/logs/odd_pflow_v1_clic_arch_20260120-T111816
export CKPT_PATH=${M_ODD}/ckpts/ # specify epoch and step
