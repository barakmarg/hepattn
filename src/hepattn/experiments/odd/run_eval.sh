...
export M_ODD=/storage/agrp/barakma/hepattn/src/hepattn/experiments/odd/logs/odd_pflow_v1_clic_arch_20260112-T143417
export CKPT_PATH=${M_ODD}/ckpts/epoch=199-val_loss=4.48795.ckpt # specify epoch and step
...
python main.py test --config configs/base.yaml --ckpt_path $CKPT_PATH --data.num_workers 0
popd
